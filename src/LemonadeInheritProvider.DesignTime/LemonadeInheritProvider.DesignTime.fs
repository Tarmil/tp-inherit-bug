module LemonadeInheritProviderImplementation
...
type BasicGenerativeProvider (config : TypeProviderConfig) as this =
    inherit TypeProviderForNamespaces (config, assemblyReplacementMap=[("LemonadeInheritProvider.DesignTime", "LemonadeInheritProvider.Runtime")])

    let ns = "LemonadeInheritProvider"
