module LemonadeInheritProviderTests


open MyNamespace
open NUnit.Framework

type Generative2 = LemonadeInheritProvider.GenerativeProvider<2>
type Generative4 = LemonadeInheritProvider.GenerativeProvider<4>
